...
# Events: 3d, 60d
targetOutputPartitioned = targetOutputPartitioned.withColumn('ERV_3d_Average', F.avg('EventReportValue').over(rolling3d_window)) \
                                                 .withColumn('ERV_60d_Average', F.avg('EventReportValue').over(rolling60d_window))

# Goldstein: 3d, 60d
targetOutputPartitioned = targetOutputPartitioned.withColumn('GRV_3d_Average', F.avg('GoldsteinReportValue').over(rolling3d_window)) \
                                                 .withColumn('GRV_60d_Average', F.avg('GoldsteinReportValue').over(rolling60d_window))

# Tone: 3d, 60d
targetOutputPartitioned = targetOutputPartitioned.withColumn('TRV_3d_Average', F.avg('ToneReportValue').over(rolling3d_window)) \
                                                 .withColumn('TRV_60d_Average', F.avg('ToneReportValue').over(rolling60d_window))
...
# create a 12 months previous to the current day (row), using previous casting of timestamp to long (number of seconds)
rolling12m_window = Window.partitionBy('ActionGeo_CountryName','EventRootCode').orderBy(F.col('EventDate').cast('timestamp').cast('long')).rangeBetween(-days(365), 0)

# create a 24 months previous to the current day (row), using previous casting of timestamp to long (number of seconds)
rolling24m_window = Window.partitionBy('ActionGeo_CountryName','EventRootCode').orderBy(F.col('EventDate').cast('timestamp').cast('long')).rangeBetween(-days(730), 0)
...
# identify outliers
assessVariableOutliers = targetOutputTimelines.withColumn('ERV_3d_MaxOutlier', max_outliers_udf('ERV_3d_Average','ERV_3d_12m_quantile75','ERV_3d_12m_IQR')) \
                                             .withColumn('ERV_60d_MaxOutlier', max_outliers_udf('ERV_60d_Average','ERV_60d_24m_quantile75','ERV_60d_24m_IQR')) \
                                             .withColumn('GRV_3d_MinOutlier', min_outliers_udf('GRV_3d_Average','GRV_3d_12m_quantile25','GRV_3d_12m_IQR')) \
                                             .withColumn('GRV_60d_MinOutlier', min_outliers_udf('GRV_60d_Average','GRV_60d_24m_quantile25','GRV_60d_24m_IQR')) \
                                             .withColumn('TRV_3d_MinOutlier', min_outliers_udf('TRV_3d_Average','TRV_3d_12m_quantile25','TRV_3d_12m_IQR')) \
                                             .withColumn('TRV_60d_MinOutlier', min_outliers_udf('TRV_60d_Average','TRV_60d_24m_quantile25','TRV_60d_24m_IQR'))
...
cols = ['ActionGeo_CountryName','UNICEF_regions','EventDate','QuadClass','EventRootCode','nArticles',
       'EventReportValue','ERV_3d_Average','ERV_3d_MaxOutlier','ERV_60d_Average','ERV_60d_MaxOutlier',
       'GoldsteinReportValue','GRV_3d_Average','GRV_3d_MinOutlier','GRV_60d_Average','GRV_60d_MinOutlier',
